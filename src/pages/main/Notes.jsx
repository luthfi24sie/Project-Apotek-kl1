            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <input
                        ...
                        required
                        disabled={loading}
                        className="w-full p-3 bg-gray-50 rounded-2xl border border-border-default focus:outline-none
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full px-6 py-3 bg-primary hover:bg-primary-hover text-white font-semibold
                            rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary
